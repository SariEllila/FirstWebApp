...
<div class="mission_wildlife_charities">
    ...
    <img src="./images/mangrove.jpg" alt="painting of river with mangrove trees on the sides and different animals in the water and on the trees"/>
</div>

<div class="mission_ocean_charities">
<img src="./images/Ocean_cleanup.jpg" alt="a beach full of plastic waste and some people walking between it"/>
    ...
    <button class="ocean_webpage_link">Visit the Webpage</button>
    </div>
</div>
